...
[specialPatterns — 핵심 포인트]
- 학생이 시험에서 헷갈릴 만한 **중요한** 어법 포인트만 엄선. **1~4개**.
- 다음 같은 진짜 중요한 포인트만 포함:
  - 도치 / 가정법 / It-that 강조 / 가주어 진주어 / 동격
  - 비교 구문 (as~as, more~than, 최상급의 함정)
  - so~that / too~to / such~that
  - 관계대명사·관계부사의 선행사 매칭 (혼동 가능 시)
  - 분사구문 / with 분사
  - 사역동사·지각동사 + 동사원형/ing 구조
  - have+O+pp (사역/경험)
  - 의문사 + to부정사
  - 학생이 자주 틀리는 수일치·시제·태
- 다음은 **포함하지 말 것** (평범한 부분):
  - 단순 전치사구 (시간/장소 표현 등 평이한 것)
